...
/*
 * Digit assignments for led displays
 * ----------------------------------
 * Digit	|	Assignment
 * ---------|--------------
 *	0		|	Water RGB LED
...
#define W_TEMP W_TEMP_LED
#define OIL_PR OIL_PR_LED
#define FUEL_L FUEL_L_LED
#define BATT_V BATT_V_LED
...
#define	RGB_BLUE	0b00100000
#define RGB_RED		0b00010000
...
#define MAX_DISP_GEAR	6

#define DBG_CAN_LED	0b00000001
#define DBG_TIC_LED	0b00000010
#define DBG_RUN_LED 0b00000100

#define REFRESH_SCREEN	60
#define DASH_UPDATE_MS	20
#define	DASH_BLINK_MS	140
#define N_CURSOR_THRESH	9

static u8 graphics[1][8] = {
